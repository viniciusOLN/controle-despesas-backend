...
public class PaymentTypesController {
    ...
    PaymentTypesController(PaymentService paymentService){
    ...
    @PostMapping
    public ResponseEntity<ResponseBase<String>> create(@RequestBody PaymentTypeRequest request) {
        paymentService.create(request);
        return ResponseEntity.ok(ResponseBase.ok("Tipo de pagamento criado com sucesso!"));
    }

    @PutMapping("/{id}")
    public ResponseEntity<ResponseBase<String>> update(@PathVariable Long id, @RequestBody PaymentTypeRequest request) {
